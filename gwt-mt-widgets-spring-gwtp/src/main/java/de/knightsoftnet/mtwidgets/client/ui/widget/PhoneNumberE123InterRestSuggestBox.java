...
public class PhoneNumberE123InterRestSuggestBox extends AbstractPhoneNumberRestSuggestBox {
   ...
   */
  @Inject
  public PhoneNumberE123InterRestSuggestBox(final RestDispatch pdispatcher,
  ...
  public void formatValue(final ValueWithPosAndCountry<String> pkey,
    ...
    this.dispatcher.execute(this.service.formatE123InternationalWithPos(pkey), presult);
  }
