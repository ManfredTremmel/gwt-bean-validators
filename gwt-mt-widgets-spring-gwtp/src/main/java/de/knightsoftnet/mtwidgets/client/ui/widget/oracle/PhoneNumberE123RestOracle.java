 ...
 *
 */
public class PhoneNumberE123RestOracle
    extends AbstractPhoneNumberRestOracle<PhoneNumberE123ItemSuggest> {

  /**
   * default constructor.
   */
  @Inject
  public PhoneNumberE123RestOracle(final RestDispatch pdispatcher,
      final PhoneNumberRestService pservice, final Session psession) {
    super(PhoneNumberE123ItemSuggest.class, pdispatcher, pservice, psession);
  }

  @Override
  protected PhoneNumberE123ItemSuggest createInstance(final PhoneNumberData pentry) {
    return new PhoneNumberE123ItemSuggest(pentry.getCountryCode(), pentry.getCountryName(),
