...
/**
 * test for must be smaller validator with date values.
 *
 * @author Manfred Tremmel
 *
 */
public class MustBeSmallerDateTest extends AbstractValidationTest<MustBeSmallerDateTestBean> {
  ...
  public final void testBothEmptyIsAllowed() {
    for (final MustBeSmallerDateTestBean testBean : MustBeSmallerDateTestCases
        .getEmptyTestBeans()) {
