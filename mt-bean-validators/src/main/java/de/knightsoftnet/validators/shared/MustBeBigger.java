...
import de.knightsoftnet.validators.shared.impl.MustBeBiggerValidator;
 ...
 * </ul>
 * the entry of <code>field1</code> must be bigger then entry of <code>field2</code>, can be used
...
public @interface MustBeBigger {
   ...
   */
  String message() default "{deKnightsoftnetValidatorsSharedValidationMustBeBiggerMessage}";
  ...
  /**
   * Defines several {@code MustBeBigger} annotations on the same element.
   */
  @Target({ElementType.TYPE, ElementType.ANNOTATION_TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
