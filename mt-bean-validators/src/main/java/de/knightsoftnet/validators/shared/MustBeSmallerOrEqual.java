...
import de.knightsoftnet.validators.shared.impl.MustBeSmallerOrEqualValidator;
 ...
 * </ul>
 * the entry of <code>field1</code> must be smaller or equal then entry of <code>field2</code>, can
...
public @interface MustBeSmallerOrEqual {
   ...
   */
  String message() default "{deKnightsoftnetValidatorsSharedValidationMustBeSmallerOrEqualMessage}";
  ...
  /**
   * Defines several {@code MustBeSmallerOrEqual} annotations on the same element.
   */
  @Target({ElementType.TYPE, ElementType.ANNOTATION_TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
