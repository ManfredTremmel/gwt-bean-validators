...
public class MustBeBiggerOrEqualValidator
    implements ConstraintValidator<MustBeBiggerOrEqual, Object> {
   ...
   */
  @Override
  public final void initialize(final MustBeBiggerOrEqual pconstraintAnnotation) {
  ...
  public final boolean isValid(final Object pvalue, final ConstraintValidatorContext pcontext) {
    ...
    try {
      ...
      if (!bigger(field1Value, field2Value)) {
