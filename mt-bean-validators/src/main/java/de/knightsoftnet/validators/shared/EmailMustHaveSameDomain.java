...
import de.knightsoftnet.validators.shared.impl.EmailMustHaveSameDomainValidator;
 ...
 * </ul>
 * the eMail entry of <code>field1</code> must have the same domain as the eMail entry of
 * <code>field2</code>.<br>
...
public @interface EmailMustHaveSameDomain {
   ...
   */
  String message() default "{deKnightsoftnetValidatorsSharedValidation"
      + "EmailMustHaveSameDomainMessage}";
   ...
   *
   * @return field/path contains first entry
   */
  String field1();
   ...
   *
   * @return field/path contains second entry
   */
  String field2();
  ...
  /**
   * Defines several {@code EmailMustHaveSameDomain} annotations on the same element.
   */
  @Target({ElementType.TYPE, ElementType.ANNOTATION_TYPE})
  @Retention(RetentionPolicy.RUNTIME)
  @Documented
