...
/**
 * A custom {@link ConstraintViolation} which allows to get additional information for a constraint
 * violation.
 *
 * @since 5.3
 */
public interface HibernateConstraintViolation<T> extends ConstraintViolation<T> {
   ...
   *         {@link HibernateConstraintValidatorContext#withDynamicPayload(Object)} or {@code null}
