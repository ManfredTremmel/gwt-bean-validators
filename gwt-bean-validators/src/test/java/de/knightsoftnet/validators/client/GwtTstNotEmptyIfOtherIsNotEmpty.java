...
/**
 * test for not empty if other is not empty validator.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstNotEmptyIfOtherIsNotEmpty extends
    AbstractValidationTst<NotEmptyIfOtherIsNotEmptyTestBean> {
