...
/**
 * test for not empty alternate validator.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstNotEmptyAlternateIfOtherHasValue extends
    AbstractValidationTst<NotEmptyAlternateIfOtherHasValueTestBean> {
