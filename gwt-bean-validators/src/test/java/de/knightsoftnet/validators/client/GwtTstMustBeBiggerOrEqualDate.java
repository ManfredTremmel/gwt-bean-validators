...
import de.knightsoftnet.validators.shared.testcases.MustBeBiggerOrEqualDateTestCases;

/**
 * test for must be bigger or equal validator with date values.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstMustBeBiggerOrEqualDate
    extends AbstractValidationTst<MustBeBiggerOrEqualDateTestBean> {

  /**
   * both entries are empty, allowed.
   */
  public final void testBothEmptyIsAllowed() {
    for (final MustBeBiggerOrEqualDateTestBean testBean : MustBeBiggerOrEqualDateTestCases
        .getEmptyTestBeans()) {
