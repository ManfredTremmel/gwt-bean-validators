...
public class GwtTestBeanValidatorsSuite extends GWTTestSuite {
  ...
  private static void appendMtBeanValidatorTests(final GWTTestSuite psuite) {
    ...
    psuite.addTestSuite(GwtTstMustBeBiggerDate.class);
    psuite.addTestSuite(GwtTstMustBeBiggerInteger.class);
    psuite.addTestSuite(GwtTstMustBeBiggerOrEqualDate.class);
    psuite.addTestSuite(GwtTstMustBeBiggerOrEqualInteger.class);
    psuite.addTestSuite(GwtTstMustBeSmallerDate.class);
    ...
    psuite.addTestSuite(GwtTstTaxNumber.class);
  ...
  private static void appendHibernateBeanValidatorTests(final GWTTestSuite psuite) {
    ...
    psuite.addTestSuite(GwtTstHibernateIsbn10.class);
    psuite.addTestSuite(GwtTstHibernateIsbn13.class);
