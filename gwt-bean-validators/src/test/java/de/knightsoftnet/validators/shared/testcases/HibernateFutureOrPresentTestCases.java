...
public class HibernateFutureOrPresentTestCases {
  ...
  public static final List<HibernateFutureOrPresentTestBean> getCorrectTestBeans() {
    final List<HibernateFutureOrPresentTestBean> correctCases =
        new ArrayList<>();
    correctCases.add(new HibernateFutureOrPresentTestBean(null));
    correctCases.add(new HibernateFutureOrPresentTestBean(getFutureDate()));
  ...
  public static final List<HibernateFutureOrPresentTestBean> getWrongtoSmallTestBeans() {
    final List<HibernateFutureOrPresentTestBean> wrongCases =
        new ArrayList<>();
    wrongCases.add(new HibernateFutureOrPresentTestBean(getPastDate()));
