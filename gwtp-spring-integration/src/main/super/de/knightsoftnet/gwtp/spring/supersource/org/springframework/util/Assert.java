...
public abstract class Assert {
   ...
   */
  public static void hasLength(@Nullable final String text, final String message) {
   ...
   * @since 5.0
   */
  public static void hasLength(@Nullable final String text,
      final Supplier<String> messageSupplier) {
    if (!StringUtils.hasLength(text)) {
      throw new IllegalArgumentException(Assert.nullSafeGet(messageSupplier));
    }
   ...
   * @since 5.0
   */
  public static void hasText(@Nullable final String text, final Supplier<String> messageSupplier) {
    if (!StringUtils.hasText(text)) {
      throw new IllegalArgumentException(Assert.nullSafeGet(messageSupplier));
    }
  }
   ...
   */
  @Deprecated
  public static void hasText(@Nullable final String text) {
    Assert.hasText(text,
   ...
   */
  public static void doesNotContain(@Nullable final String textToSearch, final String substring,
   ...
   */
  public static void notEmpty(@Nullable final Object[] array, final String message) {
   ...
   */
  public static void notEmpty(@Nullable final Collection<?> collection, final String message) {
   ...
   */
  public static void notEmpty(@Nullable final Map<?, ?> map, final String message) {
   ...
   *        ends in ":" or ";" or "," or ".", a full exception message will be appended. If it ends
   *        in a space, the name of the offending object's type will be appended. In any other case,
   *        a ":" with a space and the name of the offending object's type will be appended.
   ...
   * @param message a message which will be prepended to provide further context. If it is empty or
   *        ends in ":" or ";" or "," or ".", a full exception message will be appended. If it ends
   *        in a space, the name of the offending sub type will be appended. In any other case, a
   *        ":" with a space and the name of the offending sub type will be appended.
   * @throws IllegalArgumentException if the classes are not assignable
   */
  @GwtIncompatible("incompatible method")
  public static void isAssignable(final Class<?> superType, @Nullable final Class<?> subType,
      final String message) {
  ...
  private static void instanceCheckFailed(final Class<?> type, @Nullable final Object obj,
      @Nullable final String msg) {
    final String className = obj != null ? obj.getClass().getName() : "null";
    String result = "";
  ...
  private static void assignableCheckFailed(final Class<?> superType,
      @Nullable final Class<?> subType, @Nullable final String msg) {
    String result = "";
    boolean defaultMessage = true;
    if (StringUtils.hasLength(msg)) {
      if (Assert.endsWithSeparator(msg)) {
