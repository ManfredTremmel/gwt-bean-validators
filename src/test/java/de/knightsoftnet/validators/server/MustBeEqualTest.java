 ...
 *
 */
public class MustBeEqualTest extends AbstractValidationTest<MustBeEqualTestBean> {
  ...
  public final void testBothEmptyIsAllowed() {
    for (final MustBeEqualTestBean testBean : MustBeEqualTestCases.getEmptyTestBeans()) {
  ...
  public final void testBothEqualIsAllowed() {
    for (final MustBeEqualTestBean testBean : MustBeEqualTestCases.getCorrectTestBeans()) {
      super.validationTest(testBean, true, null);
    }
  }
  ...
  public final void testBothDifferWrong() {
    for (final MustBeEqualTestBean testBean : MustBeEqualTestCases.getWrongTestBeans()) {
      super.validationTest(testBean, false,
          "de.knightsoftnet.validators.shared.impl.MustBeEqualValidator");
    }
  }
}
