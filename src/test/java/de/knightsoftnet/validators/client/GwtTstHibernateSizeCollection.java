...
/**
 * test for hibernate size array validator.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstHibernateSizeCollection
    extends AbstractValidationTst<HibernateSizeCollectionTestBean> {

  /**
   * correct size are allowed.
   */
  public final void testCorrectSizeCollectionAreAllowed() {
    for (final HibernateSizeCollectionTestBean testBean : HibernateSizeCollectionTestCases
        .getCorrectTestBeans()) {
