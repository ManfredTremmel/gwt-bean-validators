...
/**
 * test for must be smaller or equal validator with integer values.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstMustBeSmallerOrEqualInteger
    extends AbstractValidationTst<MustBeSmallerOrEqualIntegerTestBean> {

  /**
   * both entries are empty, allowed.
   */
  public final void testBothEmptyIsAllowed() {
    for (final MustBeSmallerOrEqualIntegerTestBean testBean : MustBeSmallerOrEqualIntegerTestCases
        .getEmptyTestBeans()) {
  ...
  public final void testBothDifferWrong() {
    for (final MustBeSmallerOrEqualIntegerTestBean testBean : MustBeSmallerOrEqualIntegerTestCases
      ...
      super.validationTest(testBean, false,
          "de.knightsoftnet.validators.shared.impl.MustBeSmallerOrEqualValidator");
    }
  }
}
