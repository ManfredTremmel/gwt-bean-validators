...
/**
 * test for must be smaller or equal validator with date values.
 *
 * @author Manfred Tremmel
 *
 */
public class GwtTstMustBeSmallerOrEqualDate
    extends AbstractValidationTst<MustBeSmallerOrEqualDateTestBean> {

  /**
   * both entries are empty, allowed.
   */
  public final void testBothEmptyIsAllowed() {
    for (final MustBeSmallerOrEqualDateTestBean testBean : MustBeSmallerOrEqualDateTestCases
        .getEmptyTestBeans()) {
