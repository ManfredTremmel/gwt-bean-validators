...
/**
 * test for hibernate digits validator.
 *
...
public class GwtTstHibernateDigits extends AbstractValidationTst<HibernateDigitsTestBean> {
  ...
  /**
   * correct decimal are allowed.
   */
  public final void testCorrectDigitsAreAllowed() {
    for (final HibernateDigitsTestBean testBean : HibernateDigitsTestCases.getCorrectTestBeans()) {
      super.validationTest(testBean, true, null);
    }
  }

  /**
   * wrong decimal are not allowed.
   */
  public final void testToSmallDigitsAreWrong() {
    for (final HibernateDigitsTestBean testBean : HibernateDigitsTestCases.getWrongTestBeans()) {
