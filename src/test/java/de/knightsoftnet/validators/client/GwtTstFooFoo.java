...
public class GwtTstFooFoo extends AbstractValidationTst<Foo> {
  ...
  /**
   * correct fooFoos are allowed.
   */
  public final void testCorrectFooFoosAllowed() {
    for (final FooFoo testBean : FooFooTestCases.getCorrectTestBeans()) {
  ...
  public final void testWrongFooFoosAreWrong() {
    for (final FooFoo testBean : FooFooTestCases.getWrongTestBeans()) {
