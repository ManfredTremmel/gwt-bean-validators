...
public class GwtTestNotEmptyIfOtherHasValueTest extends
  ...
  public final void testValueIsSetFieldsNotWrong() {
    super.validationTest(new NotEmptyIfOtherHasValueTestBean("street", null, null), false,
        "de.knightsoftnet.validators.shared.impl.NotEmptyIfOtherHasValueValidator");
    super.validationTest(new NotEmptyIfOtherHasValueTestBean("street", "", null), false,
        "de.knightsoftnet.validators.shared.impl.NotEmptyIfOtherHasValueValidator");
    super.validationTest(new NotEmptyIfOtherHasValueTestBean("postOfficeBox", null, null), false,
        "de.knightsoftnet.validators.shared.impl.NotEmptyIfOtherHasValueValidator");
    super.validationTest(new NotEmptyIfOtherHasValueTestBean("postOfficeBox", null, ""), false,
        "de.knightsoftnet.validators.shared.impl.NotEmptyIfOtherHasValueValidator");
  }
}
