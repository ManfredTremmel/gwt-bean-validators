...
/**
 * get test cases for hibernate assert false test.
 *
...
public class HibernateAssertFalseTestCases {
  ...
  public static final List<HibernateAssertFalseTestBean> getCorrectTestBeans() {
    final List<HibernateAssertFalseTestBean> correctCases =
        new ArrayList<HibernateAssertFalseTestBean>();
    correctCases.add(new HibernateAssertFalseTestBean(null));
    correctCases.add(new HibernateAssertFalseTestBean(Boolean.FALSE));
    return correctCases;
  }
  ...
  public static final List<HibernateAssertFalseTestBean> getWrongTestBeans() {
    final List<HibernateAssertFalseTestBean> wrongCases =
        new ArrayList<HibernateAssertFalseTestBean>();
    wrongCases.add(new HibernateAssertFalseTestBean(Boolean.TRUE));
    return wrongCases;
  }
}
