...
public class MustBeEqualTestCases {
  ...
  public static final List<MustBeEqualTestBean> getEmptyTestBeans() {
    ...
    correctCases.add(new MustBeEqualTestBean(null, null));
  ...
  public static final List<MustBeEqualTestBean> getCorrectTestBeans() {
    final List<MustBeEqualTestBean> correctCases = new ArrayList<MustBeEqualTestBean>();
    correctCases.add(new MustBeEqualTestBean("filled", "filled"));
    return correctCases;
  }
  ...
  public static final List<MustBeEqualTestBean> getWrongTestBeans() {
    ...
    wrongCases.add(new MustBeEqualTestBean(null, "filled"));
    wrongCases.add(new MustBeEqualTestBean("", "filled"));
    wrongCases.add(new MustBeEqualTestBean("filled", null));
    wrongCases.add(new MustBeEqualTestBean("filled", ""));
    wrongCases.add(new MustBeEqualTestBean("filled", "filledother"));
    return wrongCases;
  }
}
