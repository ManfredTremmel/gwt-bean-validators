...
public class EmptyIfOtherIsEmptyTestBean implements ReflectedBean {
   ...
   */
  public EmptyIfOtherIsEmptyTestBean(final String pstreet, final String pstreetNumber) {
    super();
    this.street = pstreet;
  ...
  public String toString() {
    return "EmptyIfOtherIsEmptyTestBean [street=" + this.street + ", streetNumber="
        + this.streetNumber + "]";
  }
}
