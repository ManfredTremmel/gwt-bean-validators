...
public class PhoneNumberValueRestTestBean {
   ...
   */
  public PhoneNumberValueRestTestBean(final String pcountryCode, final String pphoneNumber) {
    super();
  ...
  public String toString() {
    return "PhoneNumberValueRestTestBean [countryCode=" + this.countryCode + ", phoneNumber="
        + this.phoneNumber + "]";
  }
}
