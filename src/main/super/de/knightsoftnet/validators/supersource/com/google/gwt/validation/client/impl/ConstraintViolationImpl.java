...
public class ConstraintViolationImpl<T>
  ...
  protected ConstraintViolationImpl(final String pmessage, final String pmessageTemplate,
      ...
      final ConstraintDescriptor<?> pconstraintDescriptor) {
    super(pmessage, pmessageTemplate, prootBean, prootBeanClass, pleafBean, ppropertyPath,
        pinvalidValue, pelementType, pconstraintDescriptor);
  }
}
