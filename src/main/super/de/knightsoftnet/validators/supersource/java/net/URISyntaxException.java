...
public class URISyntaxException extends Exception {
   ...
   * @param index The index at which the parse error occurred, or <tt>-1</tt> if the index is not
   *        known
   *
   ...
   * <tt>-1</tt> if this position is not known.
   *
   ...
   * followed by a colon character (<tt>':'</tt>), a space, and the input string. If the error index
   * is defined then the string <tt>" at index "</tt> followed by the index, in decimal, is inserted
