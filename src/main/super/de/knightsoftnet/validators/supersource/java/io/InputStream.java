 ...
 * </p>
 *
 * <h3>Subclassing InputStream</h3> Subclasses that decorate another input stream should consider
 * subclassing {@link FilterInputStream}, which delegates all calls to the source input stream.
 *
 * <p>
 * All input stream subclasses should override <strong>both</strong> {@link #read() read()} and
...
public abstract class InputStream extends Object implements Closeable { // NOPMD
   ...
   * read may still block waiting for I/O to complete&nbsp;&mdash; the guarantee is merely that it
   ...
   *
   * <p>
   * It is particularly important to realize that you <i>must not</i> use this method to size a
