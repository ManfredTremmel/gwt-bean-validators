  ...
  public static Map<String, String> readPhoneRegionCodes(final String pphoneCountryCode) {
    ...
    switch (pphoneCountryCode) {
      ...
      case "48":
        ...
        break;
      case "49":
        final PhoneRegionCode49Constants regionCodes49 =
            GWT.create(PhoneRegionCode49Constants.class);
        phoneRegionCodes = regionCodes49.phoneRegionCodes49();
        break;
      case "49b":
        final PhoneRegionCode49bConstants regionCodes49b =
            GWT.create(PhoneRegionCode49bConstants.class);
        phoneRegionCodes = regionCodes49b.phoneRegionCodes49b();
        break;
      case "500":
