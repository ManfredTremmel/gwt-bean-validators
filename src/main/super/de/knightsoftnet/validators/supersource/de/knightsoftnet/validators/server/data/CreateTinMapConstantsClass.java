...
import de.knightsoftnet.validators.client.data.TinMapConstants;
...
public class CreateTinMapConstantsClass {
  ...
  private static volatile TinMapConstants tinMapConstants = null;
  ...
  public static TinMapSharedConstants create() {
    if (tinMapConstants == null) { // NOPMD it's thread save!
      synchronized (TinMapConstants.class) {
        if (tinMapConstants == null) {
          tinMapConstants = GWT.create(TinMapConstants.class);
        }
      }
    }
