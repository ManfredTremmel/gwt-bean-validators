...
public interface GwtSpecificValidator<G> {
   ...
   */
  <T> void expandDefaultAndValidateClassGroups(GwtValidationContext<T> context, G object,
   ...
   * @param groups What group(s) to validate.
   */
  <T> void expandDefaultAndValidatePropertyGroups(GwtValidationContext<T> context, G object,
      String propertyName, Set<ConstraintViolation<T>> violations, Group... groups);
   ...
   * @param groups What group(s) to validate.
   */
  <T> void expandDefaultAndValidateValueGroups(GwtValidationContext<T> context, Class<G> beanType,
   ...
   */
  <T> Set<ConstraintViolation<T>> validate(GwtValidationContext<T> context, G object,
   ...
   * @param groups What group(s) to validate.
   */
  <T> void validateClassGroups(GwtValidationContext<T> context, G object,
  ...
  <T> Set<ConstraintViolation<T>> validateProperty(GwtValidationContext<T> context, G object,
      String propertyName, Class<?>... groups) throws ValidationException;
   ...
   * @param groups What group(s) to validate.
   */
  <T> void validatePropertyGroups(GwtValidationContext<T> context, G object, String propertyName,
      Set<ConstraintViolation<T>> violations, Class<?>... groups);
   ...
   * @throws ValidationException if a non recoverable error happens during the validation process
   */
  <T> Set<ConstraintViolation<T>> validateValue(GwtValidationContext<T> context, Class<G> beanType,
      String propertyName, Object value, Class<?>... groups) throws ValidationException;
   ...
   * @param groups What group(s) to validate.
   */
  <T> void validateValueGroups(GwtValidationContext<T> context, Class<G> beanType,
      String propertyName, Object value, Set<ConstraintViolation<T>> violations,
      Class<?>... groups);
}
