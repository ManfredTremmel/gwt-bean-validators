 ...
 */
public class PhoneNumberMsKeyUpHandler extends AbstractFormatKeyUpHandler {
   ...
   */
  public PhoneNumberMsKeyUpHandler(final HasValue<?> pcountryCodeField) {
    super();
  ...
  public String formatValue(final String pvalue) {
    ...
    final String formatedValue = this.phoneNumberUtil.formatMs(pvalue);
    return StringUtils.isEmpty(formatedValue) || StringUtils.startsWith(pvalue, formatedValue)
        && (StringUtils.endsWith(pvalue, " ") || StringUtils.endsWith(pvalue, "-")
            || StringUtils.endsWith(pvalue, "(") || StringUtils.endsWith(pvalue, ")")) ? pvalue
                : formatedValue;
  }
}
