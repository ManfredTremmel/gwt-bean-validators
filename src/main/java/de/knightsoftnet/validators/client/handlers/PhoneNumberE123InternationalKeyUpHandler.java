 ...
 */
public class PhoneNumberE123InternationalKeyUpHandler extends AbstractFormatKeyUpHandler {
   ...
   */
  public PhoneNumberE123InternationalKeyUpHandler(final HasValue<?> pcountryCodeField) {
    super();
  ...
  public String formatValue(final String pvalue) {
    ...
    final String formatedValue = this.phoneNumberUtil.formatE123International(pvalue);
