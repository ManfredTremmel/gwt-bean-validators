 ...
 */
public class PhoneNumberCommonKeyPressHandler
   ...
   */
  public PhoneNumberCommonKeyPressHandler(final HasValue<?> pcountryCodeField) {
    super(true);
  ...
  public boolean isAllowedCharacter(final char pcharacter) {
    return pcharacter == '+' || pcharacter == ' ' || pcharacter == '/' || pcharacter == '-'
        || pcharacter == '(' || pcharacter == ')' || pcharacter >= '0' && pcharacter <= '9';
  }
  ...
  public String formatValue(final String pvalue) {
    ...
    final String formatedValue = this.phoneNumberUtil.formatCommon(pvalue);
