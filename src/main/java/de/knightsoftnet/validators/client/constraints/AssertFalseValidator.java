...
public class AssertFalseValidator implements ConstraintValidator<AssertFalse, Boolean> {
  ...
  @Override
  public final void initialize(final AssertFalse constraintAnnotation) {}

  @Override
  public final boolean isValid(final Boolean value, final ConstraintValidatorContext context) {
