 ...
 *
 */
public class PhoneNumberCommonInterSuggestBox extends AbstractPhoneNumberSuggestBox {

  /**
   * default constructor.
   */
  public PhoneNumberCommonInterSuggestBox() {
    super(new PhoneNumberCommonOracle());
  }

  @Override
  public void formatValue(final ValueWithPos<String> pvalue) {
    this.setTextWithPos(this.phoneNumberUtil.formatCommonInternationalWithPos(pvalue,
