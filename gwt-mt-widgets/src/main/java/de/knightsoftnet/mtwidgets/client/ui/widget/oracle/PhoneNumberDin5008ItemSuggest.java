 ...
 *
 */
public class PhoneNumberDin5008ItemSuggest extends AbstractPhoneNumberItemSuggest {
   ...
   */
  public PhoneNumberDin5008ItemSuggest(final String pcountryCode, final String pcountryName,
