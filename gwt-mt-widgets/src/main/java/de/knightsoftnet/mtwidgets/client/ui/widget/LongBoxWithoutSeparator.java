 ...
 *
 */
public class LongBoxWithoutSeparator extends AbstractMinMaxTextBox<Long> {

  /**
   * default constructor.
   */
  public LongBoxWithoutSeparator() {
    super(LongRendererWithoutSeparator.instance(), LongParserWithoutSeparator.instance(),
