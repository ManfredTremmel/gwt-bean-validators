 ...
 *
 */
public class IntegerBoxWithoutSeparator extends AbstractMinMaxTextBox<Integer> {

  /**
   * default constructor.
   */
  public IntegerBoxWithoutSeparator() {
    super(IntegerRendererWithoutSeparator.instance(), IntegerParserWithoutSeparator.instance(),
