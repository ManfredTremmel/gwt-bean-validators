...
public class CurrencyDoubleRenderer extends AbstractRenderer<Double> {
  ...
  public static final Renderer<Double> instance() { // NOPMD it's thread save!
    if (CurrencyDoubleRenderer.instanceRenderer == null) {
      synchronized (CurrencyDoubleRenderer.class) {
        if (CurrencyDoubleRenderer.instanceRenderer == null) {
          CurrencyDoubleRenderer.instanceRenderer = new CurrencyDoubleRenderer();
        }
      }
    }
    return CurrencyDoubleRenderer.instanceRenderer;
  }
